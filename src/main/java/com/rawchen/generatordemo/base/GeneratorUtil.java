package com.rawchen.generatordemo.base;
...
public class GeneratorUtil {
	...
	// 【必须】作者名称
	protected String author = "chensq";
	...
	// 【必须】源文件夹存放路径，也是包路径
	protected String package_url = "com/rawchen/generatordemo";

	// 【必须】数据库连接参数
	protected String url = "jdbc:mysql://localhost:3306/generator_demo" + "?characterEncoding=utf8";
	...
	// 【保持】其他路径配置
	protected String root_path_full = project_path + "/src/main/java/" + package_url;
	protected String bean_path = project_path + "/src/main/java/" + package_url + "/entity";
	protected String mapper_path = project_path + "/src/main/java/" + package_url + "/mapper";
	protected String service_path = project_path + "/src/main/java/" + package_url + "/service";
	protected String controller_path = project_path + "/src/main/java/" + package_url + "/controller";
	protected String xml_path = project_path + "/src/main/resources/" + package_url + "/mapper";
	...
	private void buildController(String path, String className, String packName, List<String> columns, List<String> types, List<String> comments, String tableComment) throws IOException {
		...
		bw.newLine();
		buildClassComment(bw, modelNote + "[" + className + "]控制器");
		...
		write(bw, "@Api(tags = \"" + modelNote + "[PC端]" + className + "接口" + "\",  value = \"" + beanName + "Controller\")");
